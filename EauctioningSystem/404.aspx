<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="EauctioningSystem._404" %>
	...
	<div class="h_menu4"><!-- start h_menu4 -->
		<div class="container">
				...
				<ul class="nav">
					...
					<li><a href="careers.aspx" data-hover="Careers">Careers</a></li>
					<li><a href="contact.aspx" data-hover="Contact Us">Contact Us</a></li>
					<li class="active"><a href="404.aspx" data-hover="Company Profile">Company Profile</a></li>
					<li><a href="register.aspx" data-hover="Company Registration">Company Registration</a></li>
