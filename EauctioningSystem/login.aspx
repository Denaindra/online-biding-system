<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="EauctioningSystem.login" %>
         ...
         <div class="register">
			   ...
			   <div class="col-md-6 login-right">
				...
				<form id="login" runat="server" >
				  ...
				  <div>
					<span>Password<label>*</label></span><asp:RequiredFieldValidator ID="Validator2" runat="server" ControlToValidate="Password" ErrorMessage="Require**" Width="265px" BorderColor="#999999"/>
				   <asp:TextBox ID="Password" TextMode="Password"  runat="server" BorderStyle="None" Height="40px" Width="520px"/>
				  </div>
				  <a class="forgot" href="ForgetPassWord.aspx">Forgot Your Password?</a>
