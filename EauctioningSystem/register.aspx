<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="EauctioningSystem.register" %>
	...
	<div class="h_menu4"><!-- start h_menu4 -->
		<div class="container">
				...
				<ul class="nav">
                    ...
                    <li class="active"><a href="register.aspx" data-hover="Wish List">*New Customer</a></li>
					...
					<h3>PERSONAL INFORMATION</h3>
					 <div>
						...
						<asp:TextBox ID="First_name"  runat="server" />
                         <asp:RequiredFieldValidator ID="RequiredField1" runat="server" ErrorMessage="Required **" ControlToValidate="First_name"/>
					 </div>
					 <div>
						<span>Last Name<label>*</label></span>
						<asp:TextBox ID="Last_name"  runat="server" />
                       <asp:RequiredFieldValidator ID="RequiredField2" runat="server" ErrorMessage="Required **" ControlToValidate="Last_name"/>
					 </div>
					 <div>
				     ...
				     <div class="register-bottom-grid">
						    <h3>LOGIN INFORMATION</h3>
							 <div>
								...
								<asp:TextBox ID="Pass_word"  runat="server" Height="38px" TextMode="Password" Width="528px" />
	                            <asp:RequiredFieldValidator ID="RequiredField4" runat="server" ErrorMessage="Required **" ControlToValidate="Pass_word"/><asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="PassWord not matched" ControlToCompare="Pass_word2" ControlToValidate="Pass_word"/>
                             </div>
							 <div>
								<span>Confirm Password<label>*</label></span>
								<asp:TextBox ID="Pass_word2"  runat="server" Height="38px" TextMode="Password" Width="528px" />
                                <asp:RequiredFieldValidator ID="RequiredField5" runat="server" ErrorMessage="Required **" ControlToValidate="Pass_word2"/>
							 </div>
							 <div class="clearfix"> </div>
					 </div>
